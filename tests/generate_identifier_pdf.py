"""
Script pour générer un PDF sur test_identifier_bug.csv et le sauvegarder
"""
import sys
import os
...
print("=" * 80)
print("GÉNÉRATION PDF SUR test_identifier_bug.csv")
print("=" * 80)
...
if pdf_response.status_code == 200:
    output_path = Path(__file__).parent / "output_variables_identifier.pdf"
